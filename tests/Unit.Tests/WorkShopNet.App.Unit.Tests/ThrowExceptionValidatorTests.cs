...
{
    public class ThrowExceptionValidatorTests
    {
        private ThrowExceptionValidator testThrowExceptionValidator;

        [SetUp]
        public void SetUp()
        {
            testThrowExceptionValidator = new ThrowExceptionValidator();
        }
