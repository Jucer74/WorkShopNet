...
namespace WorkShopNet.App.Unit.Tests
{
    ...
    {
        private RegularExpressionValidator testRegularExpressionValidator;

        [SetUp]
        public void SetUp()
        {
            testRegularExpressionValidator = new RegularExpressionValidator();
        }
        ...
        public void Validate_Null_Or_Empty_Identifier_Failure()
        {
            ...
            // Act
            List<string> result = testRegularExpressionValidator.Validate(identifier);
